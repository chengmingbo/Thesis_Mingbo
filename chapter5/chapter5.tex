...
\begin{algorithm}
    \KwIn{\\
    $V = \{V_1, V_2,\cdots, V_m\},$ \Comment*[r]{cumsum coordinates for each group}
    $t = \{t_1, t_2,\cdots, t_m\},$ \Comment*[r]{group pseudo time}
    $min_{bin}=10,$\Comment*[r]{shortest trajectory minimum bin size}
    ${\theta}_{cut} = 1,$\Comment*[r]{branching point cut distance threshold}
    }
