...
In this section, we first present the results generated by the single cell multimodal integration methods~(\sref{MOJITOO:out:bench}). Next, we delve into one of the datasets, namely \texttt{multimodal-PBMC}, to interpret the components output from MOJITOO~(\sref{MOJITOO:out:pbmc}).
...
\subsection{MOJITOO components intepretion of PBMC data}
