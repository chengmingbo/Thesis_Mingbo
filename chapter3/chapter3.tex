...
\subsection{Single cell Multi-modal dimensional integration}

\subsection{Single cell trajectory inference}
...
\begin{algorithm}
	...
	\Return $\mathbf{Z}$ 
	\caption{Multimodal MOJITOO Algorithm }\label{alg:MOJITOO}
	\label{alg:MOJITOO}
\end{algorithm}
