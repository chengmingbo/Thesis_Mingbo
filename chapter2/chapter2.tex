...
1.  Develop a single cell multimodal integration method:
\begin{itemize}
	\item 
...
2. Develop a Trajectory inference method for single cell multimodal data:
