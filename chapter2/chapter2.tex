...
Single-cell multi-modal profiling is a new area. And task of the integration of single cell multimodal , although there are some tools have been developed to achieve the task of integration, there are some tools have  
...
\begin{itemize}
	...
	\item \textbf{Increasing number of cells:}  The integration methods should be efficient enough so as to cope with increasing library size. Nowadays, We can sequence as many as even millions of cells.
