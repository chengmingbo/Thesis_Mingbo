...
Cells will be encapsulated into Gel Beads-in-emulsion (GEMs) forming a droplet where gel beads include barcode and UMI to identify the single cells and gene moleculars
