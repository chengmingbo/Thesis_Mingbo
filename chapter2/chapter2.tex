...
\subsubsection{Dimensional reduction and Clustering}
\begin{description}
	\item[dimensional reduction] xxx
	\item[batch correction] xxx
	\item[clustering] xxx
\end{description}
\subsubsection{Downstream analysis}
